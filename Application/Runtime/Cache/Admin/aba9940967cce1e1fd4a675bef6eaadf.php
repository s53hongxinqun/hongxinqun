									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												<td><i class="icon-bell red"></i>【最新动态】<span style="color:blue"><?php echo ($v["desk"]); ?>号桌</span> 的菜品 <span style="color:blue"><?php echo ($v["name"]); ?></span>已烹饪完成____<a href="<?php echo U('Admin/Dish/change',array('id'=>$v['id'],'status'=>2));?>">[点击上桌]</a></td>
