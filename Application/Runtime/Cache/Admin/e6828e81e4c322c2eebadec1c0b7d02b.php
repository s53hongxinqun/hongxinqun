						...
						<div class="row">
							<div class="col-xs-12">
								<div class="table-responsive">
									<form action="<?php echo U('Type/save');?>" method="post" class='col-md-4'>		
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="form-group">
										<label for="#" class="">编辑分类名称：</label>
										  <div class="input-group">
										  	 <input type="text" name="name" value="<?php echo ($vo["name"]); ?>" class="form-control" aria-label="Amount (to the nearest dollar)">
										 ...
										 <input type="hidden" name="pid" value="<?php if(isset($_GET['pid'])): echo ($_GET['pid']); else: ?>0<?php endif; ?>"><?php endforeach; endif; else: echo "" ;endif; ?>
