	...
	<!-- 传菜员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<a href="<?php echo U('Admin/Limg/add');?>" class="btn btn-danger">添加图片</a>
                        <br>
                        <br>
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												  <?php if(is_array($imgs)): $i = 0; $__LIST__ = $imgs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														<td style="line-height:100px"><?php echo ($v["id"]); ?></td>
														<td><img src="/hongxinqun/Public/<?=$v['pic'];?>" width=160 height=100 alt="餐点图片"></td>
														<td style="line-height:100px"><?php echo date('Y-m-d H:i:s',$v['addtime']); ?></td>
								
														<td style="line-height:100px"><?php if($v["status"] == 1): ?><span class="label label-sm label-warning">已启用</span>
															<?php else: ?>
                                                            <span class="label label-sm label-inverse arrowed-in">已关闭</span><?php endif; ?>
														</td>
														<td style="line-height:100px"><?php echo ($v["turn"]); ?></td>
														<td style="line-height:100px">																
																<a href="<?php echo U('Admin/Limg/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">
																	编辑
																</a>

																<a href="<?php echo U('Admin/Limg/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-danger">
																	删除
																</a>
														</td>
