...
<!-- 餐桌管理 -->
	...
	<!-- 传菜员管理 -->
				...
				<div class="page-header">
					<h1>
						...
						<small>
							<i class="icon-double-angle-right"></i>
							角色统计
                            <span id="mydata" data-a="<?php echo ($list[0]); ?>" data-b="<?php echo ($list[1]); ?>" data-c="<?php echo ($list[2]); ?>" data-d="<?php echo ($list[3]); ?>"></span>
						</small>
                    </h1>
            <script type="text/javascript" src="/hongxinqun/Public/admin/count/jquery-1.8.3.min.js"></script>
                <style type="text/css">
        ${demo.css}
                </style>
                <script type="text/javascript">
        $(function () {
            var a = parseInt($('#mydata').data('a'));
            var b = parseInt($('#mydata').data('b'));
            var c = parseInt($('#mydata').data('c'));
            // var d = parseInt($('#mydata').data('d'));
        ...
        <script src="/hongxinqun/Public/admin/count/highcharts.js"></script>
        <script src="/hongxinqun/Public/admin/count/highcharts-3d.js"></script>
        <script src="/hongxinqun/Public/admin/count/exporting.js"></script>
