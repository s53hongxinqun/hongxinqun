		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo U('Admin/Vip/index');?>">会员管理</a>
					</li>

				</ul><!-- .breadcrumb -->

				<div class="nav-search" id="nav-search">
					<form class="form-search" action="<?php echo U('Admin/Vip/search');?>"  method="get">
			...
			<div class="page-content">
                ...
                <a href="<?php echo U('Admin/Vip/add');?>"  class="btn btn-danger">添加会员</a>
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												<td style="line-height:30px"><?php echo ($v["id"]); ?></td>
												<td style="line-height:30px"><?php echo ($v["name"]); ?></td>
												<td style="line-height:30px"><?php echo ($v["phone"]); ?></td>
												<td style="line-height:30px"><?php echo ($v["points"]); ?></td>								
												<td style="line-height:30px"><?php echo date('Y-m-d H:i:s',$v['addtime']); ?></td>
												<td style="line-height:30px"><?php if($v["status"] == 0): ?><span class="label label-sm label-warning">已启用</span>
													<?php else: ?>	
                                                    <span class="label label-sm label-inverse arrowed-in">已禁用</span><?php endif; ?>
												</td>
												<td style="line-height:30px">
													<?php if($v["status"] == 0): ?><a title="禁用" href="<?php echo U('Admin/Vip/change',array('id'=>$v['id'],'status'=>1));?>" class="btn btn-xs btn-danger">
															<i class="icon-remove bigger-120"></i>
														</a>
													<?php else: ?>
														<a title="启用" href="<?php echo U('Admin/Vip/change',array('id'=>$v['id'],'status'=>0));?>" class="btn btn-xs btn-success">
															<i class="icon-ok bigger-120"></i>
														</a><?php endif; ?>

														<a title="编辑" href="<?php echo U('Admin/Vip/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-info">
															<i class="icon-edit bigger-120"></i>
														</a>

														<a title="删除" href="<?php echo U('Admin/Vip/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-warning">
