			...
			<!-- 会员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Desk/insert');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
                         ...
                         <tr>
                         	...
                         	<td>
                         	   ...
                         	   <input class="ace" name="people" type="radio" value="0" checked >
                               <span class="lbl"> 2人</span>
                               <input class="ace" name="people" type="radio" value="1" >
                               <span class="lbl"> 4人</span>
                               <input class="ace" name="people" type="radio" value="2" >
