			...
			<!-- 会员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Vip/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
				      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" class="form-control" value="<?php echo ($v["id"]); ?>">
                         <tr>
                         	<th>真实姓名：</th>
                         	<td><input type="text" name="name" class="form-control" value="<?php echo ($v["name"]); ?>"></td>
                         </tr>
                         <tr>
                         	<th>手机号：</th>
                         	<td><input type="text" name="phone" class="form-control" value="<?php echo ($v["phone"]); ?>"></td>
                         </tr>
                         <tr>
                         	<th>状态：</th>
                         	<td>
                         	   <input class="ace" name="status" type="radio" value="0" <?php if($v["status"] == 0): ?>checked<?php endif; ?>>
                               <span class="lbl"> 启用</span>
                               <input class="ace" name="status" type="radio" value="1" <?php if($v["status"] == 1): ?>checked<?php endif; ?>>
