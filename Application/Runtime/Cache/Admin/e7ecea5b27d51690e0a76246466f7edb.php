	...
	<!-- 传菜员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Url/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
				      <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                         	<th>id：</th>
                         	<td><input type="text" name="id" class="form-control" value="<?php echo ($v["id"]); ?>" readonly="readonly"></td>
                         </tr>
                         <tr>
                         	<th>链接名：</th>
                          ...
                          <tr>
                         	<th>链接地址：</th>
                         	<td><input type="text" name="url" class="form-control" value="<?php echo ($v["url"]); ?>"></td>
                         </tr>
                         <tr>
                         	<th>状态：</th>
                         	<td>
                         ...
                         <tr>
                         	 <td></td>
                         	 <td><input type="submit" value="修改" class="btn btn-success">
