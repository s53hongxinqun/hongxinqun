				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<div class="nav-search" id="nav-search">
							<form class="form-search" action="<?php echo U('Admin/Order/search');?>"  method="get">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
												  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														...
														<td><?php echo ($v["desk"]); ?>号桌</td>
														<td><?=date('Y-m-d H:i:s',$v['addtime'])?></td>
														<td>￥<?php echo ($v["total"]); ?></td>
														<td><?php if($v["status"] == 0): ?><span class="label label-sm label-warning">待付款</span>
															<?php else: ?>
                                                            <span class="label label-sm label-inverse arrowed-in">已付款</span><?php endif; ?>
														</td>
														<td>
															<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
																
																
																<a href="<?php echo U('Admin/Order/detail',array('orderid'=>$v['orderid']));?>" class="btn btn-xs btn-success">
																  详情
																</a>
																...
																<a href="<?php echo U('Admin/Index/cstatus',array('status'=>3,'id'=>$v['desk'],'orderid'=>$v['orderid']));?>" class="btn btn-xs btn-info">
																	结账
																</a>

																<a href="<?php echo U('Admin/Order/del',array('orderid'=>$v['orderid'],'status'=>$v['status']));?>" class="btn btn-xs btn-danger">
																	删除
																</a>
															</div>
