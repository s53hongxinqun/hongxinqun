		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo U('Admin/Comment/index');?>">评论管理</a>
					</li>

				</ul><!-- .breadcrumb -->

				<div class="nav-search" id="nav-search">
					<form class="form-search" action="<?php echo U('Admin/Comment/search');?>"  method="get">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												...
												<td style="line-height:30px"><?php echo ($v["foods"]); ?></td>
												<td style="line-height:30px"><?php echo ($v["uname"]); ?></td>
												<td style="line-height:30px"><?php echo ($v["comment"]); ?></td>													
												<td style="line-height:30px"><?php echo date('Y-m-d H:i:s',$v['addtime']); ?></td>
												<td style="line-height:30px"><?php if($v["status"] == 0): ?><span class="label label-sm label-warning">显示</span>
													<?php else: ?>	
                                                    <span class="label label-sm label-inverse arrowed-in">隐藏</span><?php endif; ?>
												</td>
												<td style="line-height:30px">
													<?php if($v["status"] == 0): ?><a title="隐藏" href="<?php echo U('Admin/Comment/change',array('id'=>$v['id'],'status'=>1));?>" class="btn btn-xs btn-danger">
															<i class="icon-remove bigger-120"></i>
														</a>
													<?php else: ?>
														<a title="显示" href="<?php echo U('Admin/Comment/change',array('id'=>$v['id'],'status'=>0));?>" class="btn btn-xs btn-success">
															<i class="icon-ok bigger-120"></i>
														</a><?php endif; ?>


														<a title="删除" href="<?php echo U('Admin/Comment/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-warning">
