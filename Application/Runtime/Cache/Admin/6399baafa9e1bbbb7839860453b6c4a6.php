	...
	<!-- 传菜员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Limg/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
                         ...
                         <tr>
                         	...
                         	<img id="change_img" src="/hongxinqun/Public/<?=$imgs[0]['pic'];?>" width=100 height=80 alt="餐点图片" style="float:right">
                         	</td>
                         	<input type="hidden" name="pic" value="<?php echo ($imgs["0"]["pic"]); ?>">
                         ...
                         <tr>
                         	...
                         	<td>
                         	   ...
                         	   <input class="ace" name="status" type="radio" value="1" <?php if($imgs[0]['status'] == 1){ echo checked;} ?> >
                               <span class="lbl"> 开启</span>
                               <input class="ace" name="status" type="radio" value="2" <?php if($imgs[0]['status'] == 2){ echo checked;} ?> >
                         ...
                         <tr>
                         	<th>是否为空：</th>
                         	<td>
                         	    <input type="text" name="turn" value="<?php echo ($imgs["0"]["turn"]); ?>">
                            </td>
                         </tr>
                         <tr>
                         	 <td></td>
