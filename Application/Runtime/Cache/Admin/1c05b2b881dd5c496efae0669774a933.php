			...
			<!-- 会员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Desk/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
                         <tr>
                         	<input type="hidden" name="id" value="<?php echo ($data["0"]["id"]); ?>">
                         	<th>桌号：</th>
                         	<td><input type="text" name="id" value="<?php echo ($data["0"]["id"]); ?>" readonly="readonly"></td>
                         </tr>
                         <tr>
                         	<th>餐桌人数：</th>
                         	<td>
                         	  
                         	   <input class="ace" name="people" type="radio" value="0" <?php if($data[0]['people'] == 0){ echo checked;} ?> >
                               <span class="lbl"> 2人</span>
                               <input class="ace" name="people" type="radio" value="1" <?php if($data[0]['people'] == 1){ echo checked;} ?> >
                               <span class="lbl"> 4人</span>
                               <input class="ace" name="people" type="radio" value="2" <?php if($data[0]['people'] == 2){ echo checked;} ?> >
                               <span class="lbl"> 10人</span>
                         	   <!-- <input type="radio" name="people" value="1">新添加
                         	   <input type="radio" name="people" value="2">在售
                         	   <input type="radio" name="people" value="3">下架 -->
                         	</td>
                         </tr>
                         <tr>
