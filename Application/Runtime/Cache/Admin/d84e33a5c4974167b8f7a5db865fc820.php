		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<div class="nav-search" id="nav-search">
					<form class="form-search" action="<?php echo U('Admin/Desk/search');?>"  method="get">
			...
			<div class="page-content">
                ...
                <a href="<?php echo U('Admin/Desk/add');?>" class="btn btn-danger">添加餐桌</a>
                <br>
                <br>
				<div class="row">
					<div class="col-xs-12">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										...
										<tbody>
										  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												...
												<th style="line-height:30px"><?php if($v["people"] == 0): ?><span class="label label-sm label-warning">2人</span>
													<?php elseif($v["people"] == 1): ?>
													<span class="label label-sm label-success">4人</span>
													<?php else: ?>	
                                                    <span class="label label-sm label-inverse arrowed-in">10人</span><?php endif; ?>
												</th>
												<th style="line-height:30px">
													<?php if($v["status"] == 0): ?><span class="label label-sm label-warning">用餐中</span>
													<?php else: ?>	
	                                                    <span class="label label-sm label-inverse arrowed-in">空闲</span><?php endif; ?>
												</th>
												<th style="line-height:30px">
													<?php if($v["status"] == 0): ?><a href="<?php echo U('Admin/Desk/change',array('id'=>$v['id'],'status'=>1));?>" class="btn btn-xs btn-success">
															设置为空闲中
														</a>
													<?php else: ?>	
														<a href="<?php echo U('Admin/Desk/change',array('id'=>$v['id'],'status'=>0));?>" class="btn btn-xs btn-success">
															设置为用餐中
														</a><?php endif; ?>


														<a href="<?php echo U('Admin/Desk/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-xs btn-info">
															编辑
														</a>

														<a href="<?php echo U('Admin/Desk/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-danger">
															删除
														</a>
