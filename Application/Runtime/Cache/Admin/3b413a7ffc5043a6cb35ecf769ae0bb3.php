...
<div class="page-content">
    ...
    <a href="<?php echo U('Admin/Node/add');?>" class="btn-sm btn-success">添加节点</a>
    <br>
    <br>
	<div class="row">
		<div class="col-xs-12">
						...
						<table class="table table-striped table-bordered table-hover center">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<a class="btn-sm btn-danger" href="<?php echo U('Node/del',array('id'=>$vo['id']));?>">删除</a>
											<a class="btn-sm btn-primary" href="<?php echo U('Node/edit',array('id'=>$vo['id']));?>">修改</a>
										</td>
