			...
			<!-- 会员管理 -->
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Food/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
                         <tr>
                         	<th>餐点名：</th>
                         	<td><input type="text" name="foods" value="<?php echo ($data["0"]["foods"]); ?>"></td>
                         </tr>
                         <tr>
                         	<th>类型：</th>
                         	<td><select name="typeid">
		                 	      <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($v['id']==$data[0]['typeid'])echo selected;?>><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
		                 	    </select>
                         	</td>
                         </tr>
                         <tr>
                         	<th>单价：</th>
                         	<td><input type="text" name="price" value="<?php echo ($data["0"]["price"]); ?>"></td>
                         </tr>
                         <script type="text/javascript">
						  jQuery(function($){
                         ...
                         <tr>
                         	...
                         	<img id="change_img" src="/hongxinqun/Public/<?=$data[0]['picname'];?>" width=100 height=80 alt="餐点图片" style="float:right">
                         	</td>
                         	<input type="hidden" name="picname" value="<?php echo ($data["0"]["picname"]); ?>">
                         ...
                         <tr>
                         	...
                         	<td>
                         	   ...
                         	   <input class="ace" name="status" type="radio" value="1" <?php if($data[0]['status'] == 1){ echo checked;} ?> >
                               <span class="lbl"> 新添加</span>
                               <input class="ace" name="status" type="radio" value="2" <?php if($data[0]['status'] == 2){ echo checked;} ?> >
                               <span class="lbl"> 在售</span>
                               <input class="ace" name="status" type="radio" value="3" <?php if($data[0]['status'] == 3){ echo checked;} ?> >
                         ...
                         <tr>
                         	<th>是否为空：</th>
                         	<td><input class="ace" name="is_empty" type="radio" value="1" <?php if($data[0]['is_empty'] == 1){ echo checked;} ?> >
                               <span class="lbl"> 已售完</span>
                               <input class="ace" name="is_empty" type="radio" value="2" <?php if($data[0]['is_empty'] == 2){ echo checked;} ?> >
                               <span class="lbl"> 未售完</span>
                            </td>
                         </tr>
                         <tr>
                         	<th>描述：</th>
                         	<td><textarea rows="5" cols="40" style="resize:none" name="detail"><?php echo ($data["0"]["detail"]); ?></textarea></td>
                         </tr>
                         <tr>
                         	 <td></td>
