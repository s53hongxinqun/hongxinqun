				...
				<div class="main-content">
				    ...
				    <form action="<?php echo U('Admin/Food/save');?>" class="h4" method="post" enctype="multipart/form-data">
				      <table class="table table-striped table-hover table-condensed">
                         ...
                         <tr>
                         	<th>类型：</th>
                         	<td><input type="text" name="typeid" value="<?php echo ($data["0"]["typeid"]); ?>"></td>
                         </tr>
                         <tr>
                         	<th>单价：</th>
                         ...
                         <tr>
                         	<th>图片上传：</th>
                         	<td><input type="file" name="file" class="file" style="float:left;position:absolute">
                         	<img src="/hongxinqun/Public/<?=$data[0]['picname'];?>" width=100 height=80 alt="餐点图片" style="float:right">
                         	</td>
                         </tr>
                         <tr>
                         	<th>状态：</th>
