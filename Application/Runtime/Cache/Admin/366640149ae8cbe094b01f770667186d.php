			...
			<div class="main-container-inner" >
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <a href="<?php echo U('Admin/Food/add');?>" class="btn btn-danger">添加餐点</a>
                        <br>
                        <br>
						<div class="row">
							<div class="col-xs-12">
											...
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												<thead>
													<tr>
														...
														<th>ID</th>
														<th style="width:80px">餐点类型</th>
														<th class="hidden-480">餐点名</th>
												...
												<tbody>
												  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
														<td style="line-height:80px"><?php echo ($v["id"]); ?></td>
														<td style="line-height:80px"><?php echo ($v["typeid"]); ?></td>
														<td style="line-height:80px"><?php echo ($v["foods"]); ?></td>
														<td style="line-height:80px"><?php echo ($v["detail"]); ?></td>
														<td style="line-height:80px">￥<?php echo ($v["price"]); ?></td>
														<td><img src="/hongxinqun/Public/<?=$v['picname'];?>" width=100 height=80 alt="餐点图片"></td>
														<td style="line-height:80px"><?php if($v["status"] == 1): ?><span class="label label-sm label-warning">新添加</span>
															<?php elseif($v["status"] == 2): ?>
															<span class="label label-sm label-success">在售</span>
															<?php else: ?>	
                                                            <span class="label label-sm label-inverse arrowed-in">下架</span><?php endif; ?>
														</td>
														<td style="line-height:80px">
															<?php if($v["is_empty"] == 1): ?><span class="label label-sm label-danger">已售空</span>
															<?php else: ?>
															<span class="label label-sm label-success">未售空</span><?php endif; ?>
														</td>
														<td style="line-height:80px"><?php echo date('Y-m-d H:i:s',$v['addtime']); ?></td>
														<td style="line-height:80px">
																<a href="" class="btn btn-xs btn-success">
																	详情
																</a>

																<a href="<?php echo U('Admin/Food/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-xs btn-info">
																	编辑
																</a>

																<a href="<?php echo U('Admin/Food/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-danger">
																	删除
																</a>
