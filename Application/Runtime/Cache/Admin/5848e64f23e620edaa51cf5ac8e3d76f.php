	...
	<!-- 传菜员管理 -->
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						function phonelook(){
							...
							$.ajax({
							        type:'post',
							        dataType:'json',
							        url:"<?php echo U('Admin/Vip/phonelook');?>",
							        data:{'phone':phone},
					...
					<div class="page-content">
                        ...
                        <div class="col-xs-6">
				    <form action="<?php echo U('Admin/Vip/insert');?>" class="h4" method="post" enctype="multipart/form-data">
