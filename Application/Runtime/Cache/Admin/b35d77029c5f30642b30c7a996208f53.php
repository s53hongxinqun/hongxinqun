...
<div class="page-content">
    ...
    <a href="<?php echo U('Admin/Role/add');?>" class="btn-sm btn-success">添加角色</a>
						...
						<table class="table table-striped table-bordered table-hover center roleTable">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										...
										<td>
											<a class="btn-sm btn-danger" href="<?php echo U('Role/del',array('id'=>$vo['id']));?>">删除</a>
											<a class="btn-sm btn-primary" href="<?php echo U('Role/edit',array('id'=>$vo['id']));?>">修改</a>
											<a class="btn-sm btn-info" href="<?php echo U('Role/nodelist',array('id'=>$vo['id']));?>">分配权限</a>
										</td>
