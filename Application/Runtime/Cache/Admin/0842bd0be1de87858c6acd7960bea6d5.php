		...
		<div class="main-content">
			<div class="breadcrumbs" id="breadcrumbs">
				...
				<div class="nav-search" id="nav-search">
					<form class="form-search" action="<?php echo U('Admin/Url/search');?>"  method="get">
						<span class="input-icon">
							<input type="text" placeholder="Search " class="nav-search-input" id="nav-search-input" name="id" autocomplete="off" />
			...
			<div class="page-content">
                ...
                <a href="<?php echo U('Admin/Url/add');?>" class="btn btn-danger">添加链接</a>
                <br>
                <br>
				<div class="row">
					<div class="col-xs-12">
							...
							<div class="col-xs-12">
								<div class="table-responsive">
									<table id="sample-table-1" class="table table-striped table-bordered table-hover">
										<thead>
											<tr>											
												<th style="hidden-480">ID</th>
												<th class="hidden-480">链接名称</th>
												<th style="hidden-480">链接</th>
										...
										<tbody>
										  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
												<th style="line-height:30px"><?php echo ($v["id"]); ?></th>
												<th style="line-height:30px"><?php echo ($v["name"]); ?></th>
												<th style="line-height:30px"><?php echo ($v["url"]); ?></th>
												<th style="line-height:30px">
													<?php if($v["status"] == 0): ?><span class="label label-sm label-warning">显示</span>
													<?php else: ?>	
	                                                    <span class="label label-sm label-inverse arrowed-in">隐藏</span><?php endif; ?>
												</th>
												<th style="line-height:30px">
													<?php if($v["status"] == 0): ?><a href="<?php echo U('Admin/Url/change',array('id'=>$v['id'],'status'=>1));?>" class="btn btn-xs btn-success">
															设置为隐藏
														</a>
													<?php else: ?>	
														<a href="<?php echo U('Admin/Url/change',array('id'=>$v['id'],'status'=>0));?>" class="btn btn-xs btn-success">
															设置为显示
														</a><?php endif; ?>


														<a href="<?php echo U('Admin/Url/edit',array('id'=>$v['id']));?>" class="btn btn-xs btn-xs btn-info">
															编辑
														</a>

														<a href="<?php echo U('Admin/Url/del',array('id'=>$v['id']));?>" class="btn btn-xs btn-danger">
															删除
														</a>
