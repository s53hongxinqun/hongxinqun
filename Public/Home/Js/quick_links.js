jQuery(function($){
	...
	popTmpl = '<div class="ibar_plugin_title"><h3 style="font:20px 黑体;margin-left:90px;margin-top:8px"><%=title%></h3></div><div class="pop_panel"><%=content%></div><div class="arrow"><i></i></div><div class="fix_bg"></div>',
